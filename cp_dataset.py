...
class CPDataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        im_names = []
        c_names = []
        # print("Path",osp.join(opt.dataroot, opt.data_list))
        ...
        print("CPDataset def __init__ is running ")

    def name(self):
        print("CPDataset def name is running ")
        return "CPDataset"
    ...
    def get_agnostic(self, im, im_parse, pose_data):
        ...
        # agnostic.show()
        print("CPDataset def get_agnostic  is running ")
        return agnostic
    ...
    def __getitem__(self, index):
        ...
        for key in ['paired']:
            ...
            c[key] = f'{self.data_path}/cloth/{c_name[key]}'
            c[key] = Image.open(c[key]).convert('RGB')
        ...
        # print("image_parse_agnostic", image_parse_agnostic)
        ...
        # print("new_parse_agnostic_map", new_parse_agnostic_map)
        ...
        print("CPDataset def getitem  is running ")
        return result
...
class CPDatasetTest(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        self.c_names['paired'] = im_names
        self.c_names['unpaired'] = c_names
        print("CPDatasetTest def __init__  is running ")
    ...
    def __getitem__(self, index):
        ...
        print("CPDatasetTest def getitem  is running ")
        return result
...
class CPDataLoader(object):
    def __init__(self, opt, dataset):
        ...
        print("CPDataLoader def __init__  is running ")
    ...
    def next_batch(self):
        try:
            ...
            self.data_iter = self.data_loader.__iter__()
            batch = self.data_iter.__next__()
        print("CPDataLoader def next_batch  is running ")
        return batch
